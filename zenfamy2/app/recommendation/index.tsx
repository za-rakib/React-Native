...
const PostCard = ({ activity }: { activity: Activity }) => (
  <View className="bg-white p-4 mx-4 mb-3 rounded-xl ">
    ...
    <View className='flex-row items-center justify-end'>
      <TouchableOpacity onPress={() => router.push('./recommendation/details')} className=' px-8 h-[48px] bg-white rounded-full flex-row items-center justify-center estonBlue_bg'>
        <Text className='text-white'>Read Tip</Text>
      </TouchableOpacity>
    </View>
