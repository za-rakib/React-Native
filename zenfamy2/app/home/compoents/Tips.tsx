                ...
                renderItem={({ item }) => (
                    <View className='p-4 rounded-lg bg-[#fff] w-[260px] ml-4'>
                        ...
                        <View className='w-2/3 mt-5'>
                            <Button name={activity?"View Activity":"Read More"} onclick={() =>  router.push(activity?"./recommendation/details":"/recommendation/tips") } bgColor={colors.primaryButton} />
                        </View>
                    </View>
                )}
            />
